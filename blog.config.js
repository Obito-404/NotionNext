...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Obito', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Listen to the sudden passing of the stars.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-fn6zxaoul-obito-404.vercel.app/', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Listen to the sudden passing of the stars.',
